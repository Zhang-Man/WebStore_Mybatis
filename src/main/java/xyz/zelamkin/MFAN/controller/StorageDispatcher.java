...
import xyz.zelamkin.MFAN.manager.StorageManager;
import xyz.zelamkin.MFAN.manager.UserManager;

/**
 * Servlet implementation class StorageDispatcher
 */
@WebServlet("/storage/*")
public class StorageDispatcher extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		manager = new StorageManager(request,response);
		...
		String traget="";	
			...
			try {
				...
				m = StorageManager.class.getMethod(url, null);//获取方法
