...
import xyz.zelamkin.MFAN.manager.PageManager;

/**
 * Servlet implementation class PageDispatcher
 */
/**
 * @author lilei
 *
...
public class PageDispatcher extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		manager = new PageManager(request, response);
		...
		String traget="";	
			...
			try {
				...
				m = PageManager.class.getMethod(url, null);//获取方法
