...
import xyz.zelamkin.MFAN.manager.ProductManager;
import xyz.zelamkin.MFAN.manager.UserManager;

/**
 * Servlet implementation class ProductDispatcher
 */
/**
 * @author lilei
 *
...
public class ProductDispatcher extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		manager = new ProductManager(request,response);
		...
		String traget="";	
			...
			try {
				...
				m = ProductManager.class.getMethod(url, null);//获取方法
