									...
									<div class="card-body">
											...
											<div class="form-group row">
												<div class="col-sm-8 ml-auto">
													...
													<a id="check" href="${pageContext.request.contextPath}/customer/UpdataCustomer?id=<%=customer.getId()%>" style="margin-left: 20px;">
													<button class="btn btn-primary" name="" value="">
														修改信息
													</button></a>
												</div>
