<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<%@ page import="xyz.zelamkin.MFAN.pojo.Customer"%>
...
%>
	...
	<body>
		...
		%>
									<div class="card-body">
										<form id="signupForm" method="post" class=" right-text-label-form" action="${pageContext.request.contextPath}/customer/CustomerFormUpdataSubmit">
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="name">Name</label>
												<div class="col-sm-5">
													<input type="text" class="form-control" id="name" name="name" placeholder="name" value="<%=customer.getName() %>" />
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="tel">Tel</label>
												<div class="col-sm-5">
													<input type="tel" class="form-control" id="tel" name="tel" placeholder="Tel" value="<%=customer.getTel() %>" />
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="address">Address</label>
												<div class="col-sm-5">
													<input type="text" class="form-control" id="address" name="address" placeholder="address" value="<%=customer.getAddress() %>" />
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="email">Email</label>
												<div class="col-sm-5">
													<input type="email" class="form-control" id="email" name="mail" placeholder="Email" value="<%=customer.getMail() %>" />
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="credit">Credit</label>
												<div class="col-sm-5">
													<span><%=customer.getBank_account() %></span>
												</div>
											</div>
