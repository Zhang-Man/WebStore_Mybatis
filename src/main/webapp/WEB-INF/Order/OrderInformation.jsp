...
<%@ page import="xyz.zelamkin.MFAN.pojo.Orders"%>
		...
		%>                       	<div class="right-text-label-form">
										<div class="card-body">
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="name">负责人员</label>
												<div class="col-sm-5">
													<span id="name" name="name" class=""><%=orderuser.getUsername()%></span>
												</div>
											</div>
											
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="tel">订单客户</label>
												<div class="col-sm-5">
													<span><%=customer.getName() %></span>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="bank_account">商品名称</label>
												<div class="col-sm-5">
													<span><%=product.getTitle() %></span>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="email">创建时间</label>
												<div class="col-sm-5">
													<span><%=order.getCreate_time() %></span>
												</div>
											</div>
