...
%>
	...
	<body>
		...
		User otheruser = (User)request.getAttribute("User_two");
		...
		<div class="right-text-label-form">
										<div class="card-body">
											<div class="form-group row">
												...
												<div class="col-sm-5">
													<span id="name" name="name" class=""><%=otheruser.getUsername()%></span>
												</div>
											</div>
