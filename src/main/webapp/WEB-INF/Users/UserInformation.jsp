		...
		<div class="right-text-label-form">
										<div class="card-body">
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="name">用户名称</label>
												<div class="col-sm-5">
													<span id="name" name="name" class=""><%=user.getUsername()%></span>
												</div>
											</div>
											...
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="bank_account">邮箱</label>
												<div class="col-sm-5">
													<span><%=user.getMail() %></span>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="email">地址</label>
												<div class="col-sm-5">
													<span><%=user.getAddress() %></span>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="email">所有客户列表</label>
												<div class="col-sm-5">
 													<a href="${pageContext.request.contextPath}/customer/AllCustomers"><button class="btn btn-info">点击查看</button></a>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="email">我的客户列表</label>
												<div class="col-sm-5">
 													<a href="${pageContext.request.contextPath}/customer/MyCustomers"><button class="btn btn-info">点击查看</button></a>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="email">我的订单</label>
												<div class="col-sm-5">
 													<a href="${pageContext.request.contextPath}/order/MyOrders"><button class="btn btn-info">点击查看</button></a>
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="email">所有订单</label>
												<div class="col-sm-5">
 													<a href="${pageContext.request.contextPath}/order/AllOrders"><button class="btn btn-info">点击查看</button></a>
												</div>
											</div>
											
											<div class="form-group row">
												<div class="col-sm-8 ml-auto">
													<a id="check" href="${pageContext.request.contextPath}/user/UpdataUser">
													<button class="btn btn-primary" name="" value=""style="margin-left: -600px;">
													修改信息
													</button></a>
													<a id="check" href="${pageContext.request.contextPath}/user/UpdataUserPassword">
													<button class="btn btn-primary" name="" value="" style="width: 82px; margin-left: 10px;">
													修改密码
													</button></a>
													<a id="check" onclick="javascript:history.back(-1);" >
													<button class="btn btn-primary" name="" value="" style="width: 82px; margin-left: 10px;">
													返回
													</button></a>
