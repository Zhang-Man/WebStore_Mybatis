...
%>
							...
							<div class="card card-shadow mb-4">
								<div class="card-header">
									...
									<div class="" style="width: 30%;float: right;">
										<form role="search" class="search-form form_show" action="${pageContext.request.contextPath}/user/UserInformationSearch">
											<div class="input-group">
	...
	{	
		%>
											<tr>
												...
												<td>
													<a href="${pageContext.request.contextPath}/user/DeleteUser?id=<%=alluser.getId()%>" class="btn btn-primary">删除</a>
													<a href="${pageContext.request.contextPath}/department/InsertIntoDepartment?id=<%=alluser.getId()%>"><button class="btn btn-primary ">更改部门</button></a>
												</td>
	...
	%>
									...
									<center>
 										<a href="${pageContext.request.contextPath}/user/AddUser"><button class="btn btn-primary" name="" value="">
														添加User
										</button></a>
