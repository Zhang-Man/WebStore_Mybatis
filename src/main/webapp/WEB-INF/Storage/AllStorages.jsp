<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<%@ page import="xyz.zelamkin.MFAN.pojo.ProductNameWithCount"%>
							...
							<div class="card card-shadow mb-4">
								<div class="card-header">
									...
									<div class="" style="width: 30%;float: right;">
										<form role="search" class="search-form form_show" action="${pageContext.request.contextPath}/storage/StorageInformationSearch">
														<div class="input-group">
									...
									<table class="table">
										<thead>
											<tr>
												...
												<th scope="col"></th>
												<th scope="col"></th>
														<th scope="col">产品库存</th>
														<th scope="col"></th>
											</tr>
										</thead>
										<tbody>
											<%
List<ProductNameWithCount> alllist = (List<ProductNameWithCount>)request.getAttribute("AllList");
	for(ProductNameWithCount productnamewithcount:alllist)
	{	
		%>                              <form action="${pageContext.request.contextPath}/storage/UpdataStorage" method="post">
											<tr>
												<td scope="row">
													<%=productnamewithcount.getTitle() %>
												</td>
												<td>
												...
												<td></td>
												<td>
													<input type="text" name="id" value="<%=productnamewithcount.getId() %>" style="display:none">
													<input type="text" name="count" value="<%=productnamewithcount.getProduct_count() %>">
												</td>
												<td>
												...
												<a class="btn btn-primary" href="${pageContext.request.contextPath}/product/ProductInformation?id=<%=productnamewithcount.getId()%>">查看详情</a>
												</td>
	...
	%>
									...
									<a class="" id="check" href="${pageContext.request.contextPath}/page/ToIndex" style="margin-left: 20px;">
