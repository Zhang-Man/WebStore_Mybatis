						...
						<div class="row">
							<div class=" col-md-12">
								<div class="card card-shadow mb-4">
									...
									<div class="card-body">
										<form id="signupForm" method="post" class=" right-text-label-form" action="${pageContext.request.contextPath}/department/DepartmentFormSubmit">
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="dept_name">Department Name</label>
												<div class="col-sm-5">
											...
											<div class="form-group row">
												...
												<div class="col-sm-5">
													<input type="text" class="form-control" id="dept_info" name="dept_info" value="xyz" placeholder="dept_Info" />
												</div>
											</div>
											<div class="form-group row">
