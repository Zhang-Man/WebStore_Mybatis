...
%>
	...
	for(Department department:alldepartments)
	{
		...
		%>
											<tr>
												...
												<td></td>
												<td>
													<a href="${pageContext.request.contextPath}/department/UpdataDepartment?id=<%=department.getId()%>">更改部门信息</a>
													<a href="${pageContext.request.contextPath}/department/InsertIntoDepartmentSubmit?id=<%=department.getId()%>">添加成员</a>
												</td>
	...
	%>
									...
									<center>
									<a href="${pageContext.request.contextPath}/department/AddDepartment">
