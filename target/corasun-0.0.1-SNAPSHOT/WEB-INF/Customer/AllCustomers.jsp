	...
	for(Customer customer:allcustomers)
	{
		...
		%>
											<tr>
												...
												<td></td>
												<td>
													<a href="${pageContext.request.contextPath}/customer/CustomerInformation?id=<%=customer.getId()%>">查看详情</a>
													<a href="${pageContext.request.contextPath}/customer/DeleteCustomer?id=<%=customer.getId()%>">删除</a>
												</td>
