<%@ page language="java" contentType="text/html; charset=utf-8"
	pageEncoding="utf-8"%>
<%@ page import="xyz.zelamkin.MFAN.pojo.Department"%>
...
%>
	...
	%>
								<div class="card-body">
									<form id="signupForm" method="post" class=" right-text-label-form" action="${pageContext.request.contextPath}/department/DepartmentFormUpdataSubmit">
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="dept_name">Dept Name</label>
											<div class="col-sm-5">
												<input type="text" class="form-control" id="dept_name" name="dept_name" placeholder="dept_name" value="<%=department.getDept_name()%>" />
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="dept_info">Dept_Info</label>
											<div class="col-sm-5">
												<input type="dept_info" class="form-control" id="dept_info" name="dept_info" placeholder="Dept_info" value="<%=department.getDept_info() %>" />
											</div>
										</div>
										<div class="form-group row">
