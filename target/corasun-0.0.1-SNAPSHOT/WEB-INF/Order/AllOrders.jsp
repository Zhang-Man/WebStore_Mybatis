							...
							<div class="card card-shadow mb-4">
								<div class="card-header">
									...
									<div class="" style="width: 30%;float: right;">
										<form role="search" class="search-form form_show" action="${pageContext.request.contextPath}/order/OrderInformationSearch">
														<div class="input-group">
	...
	for(Orders order:allorders)
	{
		...
		%>
											<tr>
												...
												<td></td>
												<td>
													<a href="${pageContext.request.contextPath}/order/OrderInformation?id=<%=order.getId()%>">查看详情</a>
												</td>
