...
%>
	...
	%>
								<div class="card-body">
									...
									<form id="signupForm" method="post" class=" right-text-label-form" action="${pageContext.request.contextPath}/order/OrderFormTemporarySubmit">
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="inlineFormCustomSelectPref">Customer</label>
											<div class="col-sm-5">
		...
		%>
										...
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="inlineFormCustomSelectPref">User</label>
											<div class="col-sm-5">
												<select class="custom-select " id="user_id" name="user_id">
													<%
		for(User orderuser:allusers)
		{
			
			%>

													<option value="<%=orderuser.getId() %>">
		...
		%>
										...
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="inlineFormCustomSelectPref">Product</label>
											<div class="col-sm-5">
		...
		%>
										...
										<div class="form-group row">
											<label class="col-sm-4 control-label" for="product_count">Product Count</label>
											<div class="col-sm-5">
												<input type="text" class="form-control" id="product_count" name="product_count" placeholder="product_count" />
											</div>
										</div>
