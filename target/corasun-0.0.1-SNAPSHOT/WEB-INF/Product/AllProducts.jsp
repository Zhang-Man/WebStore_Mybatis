							...
							<div class="card card-shadow mb-4">
								<div class="card-header">
									...
									<div class="" style="width: 30%;float: right;">
										<form role="search" class="search-form form_show" action="${pageContext.request.contextPath}/product/ProductInformationSearch">
														<div class="input-group">
	...
	for(Product product:allproducts)
	{
		...
		%>
											<tr>
												...
												<td></td>
												<td>
													<a href="${pageContext.request.contextPath}/product/DeleteProduct?id=<%=product.getId() %>">删除</a>
													<a href="${pageContext.request.contextPath}/product/UpdataProduct?id=<%=product.getId()%>">修改信息</a>
													<a href="${pageContext.request.contextPath}/product/ProductInformation?id=<%=product.getId()%>">查看详情</a>
												</td>
