		...
		%>                       	<div class="right-text-label-form">
										<div class="card-body">
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="name">产品名称</label>
												<div class="col-sm-5">
													<span id="name" name="name" class=""><%=product.getTitle() %></span>
												</div>
											</div>
											
											<div class="form-group row">
												<label class="col-sm-4 control-label" for="tel">产品价格</label>
												<div class="col-sm-5">
										...
										<center>
															...
															<a href="${pageContext.request.contextPath}/product/UpdataProduct?id=<%=product.getId()%>"><button class="btn btn-primary">修改信息</button></a>
