        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    <form action="${pageContext.request.contextPath}/user/UserFormPasswordSubmit" method="post">
                    	<div id="passwordlogin">
                        <div class="form-group" >
                            <label>OldPassword</label>
                            <input type="text" class="form-control" name="oldpassword" placeholder="OldPassword"  >
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="passwordtwo" class="form-control" placeholder="Reconfirm New Password"  onblur="check()">
...
<script>
			function check() {
				if(document.getElementById("password").value != document.getElementById("passwordtwo").value) {
					document.getElementById("warning").innerHTML = "<i class='fa fa-times-circle'></i> password inconsistencie";
					return false;
				} else {
